export default function QueEs() {
  return (
    <section className="seccion">
      <div className="sec-num">02 — QUÉ ES</div>
      <div className="sec-titulo">LABORATORIO</div>
      <div className="triada">
        ...
        <div className="eje-bloque arte">
          <div className="eje-nombre">Arte</div>
          <p className="eje-texto up">
            Práctica artística como metodología. La producción estética como forma de conocimiento territorial y memoria viva.
          </p>
        </div>
      </div>
    </section>
